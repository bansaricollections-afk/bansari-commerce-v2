...
--
-- Source of truth: CREATE TABLE definitions in
--   20260802235900_production_schema_catchup.sql
--
-- Column lists verified against each CREATE TABLE:
--
--   categories   : name, slug, description, image_url, active, sort_order
--   subcategories: category_id, name, slug, description, active, sort_order
--   collections  : name, slug, description, active, featured, sort_order
...
-- ============================================================
-- categories
-- CREATE TABLE has: id, name, slug, description, image_url,
--                   active, sort_order, created_at, updated_at
-- NOT present: display_order, is_active
-- ============================================================
...
-- ============================================================
-- subcategories
-- CREATE TABLE has: id, category_id, name, slug, description,
--                   image_url, active, sort_order, created_at, updated_at
-- FK: category_id references categories(id)
-- ============================================================
insert into public.subcategories (category_id, name, slug, description, active, sort_order)
select c.id, v.name, v.slug, v.description, true, v.sort_order
from (values
  ('sarees', 'Silk Sarees',        'silk-sarees',        'Pure and art silk sarees',          1),
  ('sarees', 'Cotton Sarees',      'cotton-sarees',      'Handloom and printed cotton',       2),
  ('sarees', 'Georgette Sarees',   'georgette-sarees',   'Party and casual georgette',        3),
  ('sarees', 'Banarasi Sarees',    'banarasi-sarees',    'Authentic Banarasi weaves',         4),
  ('suits',  'Salwar Kameez',      'salwar-kameez',      'Stitched and unstitched suits',     1),
  ('suits',  'Anarkali Suits',     'anarkali-suits',     'Flared anarkali style suits',       2),
  ('suits',  'Patiala Suits',      'patiala-suits',      'Traditional Patiala style',         3),
  ('lehengas','Bridal Lehengas',   'bridal-lehengas',    'Heavy bridal lehengas',             1),
  ('lehengas','Party Lehengas',    'party-lehengas',     'Semi-formal party wear lehengas',   2),
  ('lehengas','Designer Lehengas', 'designer-lehengas',  'Contemporary designer lehengas',    3),
  ('kurtis', 'Casual Kurtis',      'casual-kurtis',      'Everyday casual kurtis',            1),
  ('kurtis', 'Festive Kurtis',     'festive-kurtis',     'Festive and occasion kurtis',       2),
  ('kurtis', 'Printed Kurtis',     'printed-kurtis',     'Block and digital print kurtis',    3)
) as v(cat_slug, name, slug, description, sort_order)
...
-- collections
-- CREATE TABLE has: id, name, slug, description, image_url,
--                   active, featured, sort_order, created_at, updated_at
-- NOT present: display_order, is_active
-- ============================================================
insert into public.collections (name, slug, description, active, featured, sort_order)
values
  ('New Arrivals',     'new-arrivals',     'Latest additions to our catalogue', true, true,  1),
  ('Bestsellers',      'bestsellers',      'Most popular picks',                true, true,  2),
  ('Festive Edit',     'festive-edit',     'Curated for festive occasions',     true, true,  3),
  ('Bridal Collection','bridal-collection','Exclusive bridal looks',            true, false, 4),
  ('Summer Refresh',   'summer-refresh',   'Light and breezy summer styles',    true, false, 5),
  ('Sale',             'sale',             'Special offers and discounts',      true, false, 6)
on conflict (slug) do nothing;

-- ============================================================
-- attr_color
-- CREATE TABLE has: id, name, slug, hex_code, active,
--                   sort_order, created_at, updated_at
-- hex_code is present in this table (nullable)
-- ============================================================
...
-- ============================================================
-- attr_fabric
-- CREATE TABLE has: id, name, slug, active, sort_order,
--                   created_at, updated_at
-- NOT present: hex_code
-- ============================================================
...
-- ============================================================
-- size_master
-- CREATE TABLE has: id, label, sort_order, created_at
-- NOT present: name, slug, active, description
-- ============================================================
...
-- ============================================================
-- size_charts
-- CREATE TABLE has: id, name, description, chart_data,
--                   created_at, updated_at
-- ============================================================
