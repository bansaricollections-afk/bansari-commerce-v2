...
/**
 * WhatsAppShare — opens a pre-filled WhatsApp message with product details.
 * Uses wa.me deep-link which works across mobile and desktop.
 */
export default function WhatsAppShare({ productName, productUrl, price }: Props) {
  function handleShare() {
    const text = encodeURIComponent(
      `Check out this beautiful piece from Bansari Collections:\n${productName} — ₹${price.toLocaleString("en-IN")}\n${productUrl}`
    );
