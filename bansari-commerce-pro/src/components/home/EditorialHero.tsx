...
const SLIDES: Slide[] = [
  {
    id: 1,
    campaign: "The Wedding Edit 2024",
    headline: "Dressed for\nYour Most\nBeautiful Moments",
    subheadline: "Handcrafted bridal lehengas & sarees that carry the weight of tradition and the lightness of love.",
    cta: "Explore Bridal",
    ...
    imageAlt: "Bansari Collection Bridal Edit",
    accent: "Bridal · Wedding · Heritage",
    position: "left",
  },
  {
    id: 2,
    campaign: "Festive Season 2024",
    headline: "The Art of\nIndian\nFestive Wear",
    subheadline: "Silk anarkalis, embroidered kurtas and festive sarees — curated for the woman who celebrates beautifully.",
    cta: "Shop Festive",
    ...
    imageAlt: "Bansari Collection Festive Edit",
    accent: "Festive · Celebration · Elegance",
    position: "center",
  },
  {
    id: 3,
    campaign: "New Season Arrivals",
    headline: "Effortless\nIndian Grace\nEvery Day",
    subheadline: "From boardroom to evening — contemporary ethnic silhouettes designed for the modern Indian woman.",
    cta: "Shop New In",
    ctaHref: "/new-arrivals",
    secondaryCta: "Collections",
    secondaryHref: "/collections",
    image: "https://images.unsplash.com/photo-1594938298603-c8148c4b4571?w=1800&q=85&auto=format&fit=crop",
    imageAlt: "Bansari Collection Contemporary Edit",
    accent: "New Season · Modern · Artisan",
    position: "right",
  },
];
