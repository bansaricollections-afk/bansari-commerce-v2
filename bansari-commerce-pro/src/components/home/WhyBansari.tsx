...
const PILLARS = [
  {
    ...
    body: "Every piece passes through at least twelve artisan hands before it reaches you. No shortcuts. No mass production. Only craft.",
    href: "/about",
  },
  {
    number: "02",
    title: "Heritage Textiles Only",
    body: "We source directly from master weavers in Varanasi, Surat, Chanderi, and Kanjivaram — the four capitals of Indian textile art.",
    href: "/collections",
  },
  {
    number: "03",
    title: "The Right Fit, Every Time",
    body: "Free size guidance, detailed measurements, and a fit team available before every order. We make sure your garment drapes perfectly.",
    href: "/contact",
  },
  {
    number: "04",
    title: "Delivered to Your Door",
    body: "Free shipping across India. Signature packaging. Each order arrives wrapped in heritage tissue and sealed with our wax stamp.",
    href: "/shipping-policy",
  },
  {
    number: "05",
    title: "30-Day Happiness Guarantee",
    body: "If the piece does not feel right, we make it right. No forms. No friction. Just a direct conversation with our team.",
    href: "/return-refund-policy",
  },
  {
    number: "06",
    title: "Conscious Luxury",
    body: "We support 500+ artisan families. Every purchase sustains a living craft, a livelihood, and an unbroken chain of tradition.",
    href: "/about",
  },
];
