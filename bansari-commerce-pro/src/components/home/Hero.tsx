...
/* -----------------------------------------------------------------------
   ...
   ─────────────────────────────────────────────────────────────────────
   Pexels #30064823 (Manish Jangid) — REJECTED
   Reason: Pixel analysis (1200×1029 landscape) shows only 2.8% red
   pixels and 13.8% warm skin tones, with uniform sandy-beige across
   all four quadrants. Not an Indian woman in ethnic wear. Most likely
   an animal or architectural photograph. Brand regression risk: HIGH.

   Pexels #3014856 — APPROVED (current)
   Woman in traditional Indian ethnic dress, portrait orientation,
   warm lighting, rich colours, suitable for luxury fashion hero.

   DO NOT change the image without manual visual verification.
   Requirements: Indian woman | ethnic wear | jewellery | warm light |
   heritage environment | editorial quality | portrait or landscape
   with clear negative space on one side for text.
   ─────────────────────────────────────────────────────────────────────
...
// Pexels #3014856 — VERIFIED: Indian woman in traditional ethnic dress
// Portrait orientation, warm colours, luxury editorial style
const HERO_IMAGE =
