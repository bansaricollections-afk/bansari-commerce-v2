...
export default function NewArrivalsRail({ products }: { products: Product[] }) {
  return (
    <div
      style={{
        display: "flex",
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Badge — genuinely new (new_arrival = true) */}
        <span
          style={{
            position: "absolute",
            top: "1rem",
        ...
        {/* Discount badge — only if a real compare price makes it genuine */}
        {discount && (
          <span
            style={{
              position: "absolute",
