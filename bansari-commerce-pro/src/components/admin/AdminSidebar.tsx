...
import {
  ...
  Tags,
  TicketPercent,
  Users, Star , Printer, Camera, Compass, BellRing } from "lucide-react";
...
const navGroups: {
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Parcel Insert", href: "/admin/parcel-insert", icon: Printer },
    ],
  },
  {
    label: "Customers",
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Waiting for Stock", href: "/admin/stock-alerts", icon: BellRing },
    ],
  },
  {
    label: "System",
