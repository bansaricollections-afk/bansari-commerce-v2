  ...
  try {
    ...
    if (pending) {
      ...
      const orderPayload = {
        ...
        shipping_address: {
          name:        typedPending.shipping_name,
          phone:       typedPending.shipping_phone,
          email:       typedPending.shipping_email ?? null,
          addressLine1: typedPending.shipping_address_line1,
          addressLine2: typedPending.shipping_address_line2 ?? null,
    ...
    const partialOrderPayload = {
      ...
      shipping_address: {
        ...
        phone:       customerPhone,
        email:       customerEmail,
        addressLine1: '[Pending — webhook recovery]',
        addressLine2: null,
        city:        '',
        state:       '',
        postalCode:  '',
